"""
This code gets and saves all debates from the API,
The amount of debate records the api holds is 10000, so
...
out = os.path.join(filepathabove, "Database", "json-all", "debates.json")
