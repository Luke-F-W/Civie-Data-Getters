...
(the file can be found in the repository) and gets a JSON of all debates of 
theirs and saves it as debate+membercode.json. I reuse this code in the
other sections (excluding lobbying). with minor tweaks.
"""
import requests
import time
import json
